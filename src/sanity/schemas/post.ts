  ...
  fields: [
    ...
    defineField({
      ...
      fields: [
        ...
        { name: "scriptType", title: "스크립트", type: "string" },
        { name: "pineVersion", title: "Pine 버전", type: "string" },
        { name: "tvLink", title: "TV 링크", type: "url" },
        { name: "relatedStrategy", title: "연관 전략", type: "string" },
